...
This is the pre-build configuration of ArchivesSpace. In order to package
this into a distributable copy, you will have to navigate to the folder in the command
line after downloading it and then run the command:

     scripts/build_release [release_name]
